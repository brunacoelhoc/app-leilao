...
export class IndicadoresAuctionResposta {
  @ApiProperty({ example: 5, description: 'Quantidade de itens deste leilao' })
  totalItens: number;

  @ApiProperty({ example: 12, description: 'Soma de lances recebidos por todos os itens do leilao' })
  totalLances: number;

  @ApiPropertyOptional({ nullable: true, example: '350.00', description: 'Maior lance entre todos os itens do leilao (Decimal(12,2) como string), null se nenhum item recebeu lance' })
